      ...
      <div className="net-worth-container">
        ...
        <div className="net-worth-grid">
          <div className="net-worth-item">
            ...
            <h3>{Utils.getPercentage(dataPoints.get("market"), totalVal)}</h3>
          </div>
          <div className="net-worth-item">
            <h2>GIC</h2>
            <h2>{Utils.formatDollar(dataPoints.get("gic"))}</h2>
            <h3>{Utils.getPercentage(dataPoints.get("gic"), totalVal)}</h3>
          </div>
          <div className="net-worth-item">
            <h2>Bank</h2>
            <h2>{Utils.formatDollar(dataPoints.get("bank"))}</h2>
            <h3>{Utils.getPercentage(dataPoints.get("bank"), totalVal)}</h3>
          </div>
          <div className="net-worth-item">
            <h2>Other</h2>
            <h2>{Utils.formatDollar(dataPoints.get("other"))}</h2>
            <h3>{Utils.getPercentage(dataPoints.get("other"), totalVal)}</h3>
          </div>
        </div>
      </div>
    </div>
