    ...
    <div className="ledger-container">
      ...
      <div className="ledger-header-grid">
        ...
        <div className="toggle-wrapper">
          ...
          <button className={filterType === 'GIC_ONLY' ? 'active' : ''} onClick={() => setFilterType('GIC_ONLY')}>GIC
          </button>
          <button className={filterType === 'MARKET_ONLY' ? 'active' : ''}
                  onClick={() => setFilterType('MARKET_ONLY')}>Market
          </button>
        </div>
        ...
        <table className="ledger-table">
          ...
          {aggregatedData.map((row, index) => (
            <tr key={index}>
              ...
              {/* Transaction counts now show the raw number value without 'tx' suffix */}
              ...
              <td style={{textAlign: 'left', paddingLeft: '24px'}}>
                <div className="child-transactions-container">
                  {row.childRecords.map((child, childIdx) => (
                    <div className="child-tx-chip" key={childIdx}>
          ...
          <tr>
            ...
            <td style={{textAlign: 'right'}} className="footer-value text-pos">
              ${totalContributedFiltered.toLocaleString(undefined, {
              minimumFractionDigits: 2,
              maximumFractionDigits: 2
            })}
            </td>
